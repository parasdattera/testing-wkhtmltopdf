...
async def convert_html_to_pdf(request: TemplateData):
  ...
  """,  
    ...
    """
        ...
        # width_r1 = f"calc({api_data['pdi_s'][0]['gps']}*1%)"
        # color_r1 =
        # print(api_data['pdi_s'])
        
        t1 = api_data['matrix'][0]['t1'].replace('\\nB', '')
        t2 = api_data['matrix'][0]['t2'].replace('\\nA', '')
        t3 = api_data['matrix'][0]['t3'].replace('\\nB', '')
        t4 = api_data['matrix'][0]['t4'].replace('\\nB', '')
        t5 = api_data['matrix'][0]['t5'].replace('\\nC', '')
        t6 = api_data['matrix'][0]['t6'].replace('\\nC', '')
        t7 = api_data['matrix'][0]['t7'].replace('\\nB', '')
        t8 = api_data['matrix'][0]['t8'].replace('\\nC', '')
        t9 = api_data['matrix'][0]['t9'].replace('\\nB', '')
    ...
    .rectangle-scmp {{
      position: relative;
      width: calc({api_data['pdi_s'][0]['gps']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][0]['gp_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    ...
    .final-done .rectangle-2t1bp {{
      position: relative;
      width: calc({api_data['pdi_s'][1]['bgp']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][1]['bgp_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    .final-done .rectangle-2t9bp {{
      position: relative;
      width: calc({api_data['pdi_s'][9]['bgp']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][9]['bgp_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-2t7bp {{
      position: relative;
      width: calc({api_data['pdi_s'][7]['bgp']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][7]['bgp_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-2t6bp {{
      position: relative;
      width: calc({api_data['pdi_s'][6]['bgp']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][6]['bgp_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-2t8bp {{
      position: relative;
      width: calc({api_data['pdi_s'][8]['bgp']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][8]['bgp_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-2t5bp {{
      position: relative;
      width: calc({api_data['pdi_s'][5]['bgp']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][5]['bgp_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-2t4bp {{
      position: relative;
      width: calc({api_data['pdi_s'][4]['bgp']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][4]['bgp_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-2t3bp {{
      position: relative;
      width: calc({api_data['pdi_s'][1]['bgp']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][3]['bgp_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-2bgp {{
      position: relative;
      width: 108px;
      height: 22px;
      background-color: {api_data['pdi_s'][2]['bgp_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    ...
    .final-done .rectangle-4t6b {{
      position: relative;
      width: calc({api_data['pdi_s'][6]['b']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][6]['b_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-4t2b {{
      position: relative;
      width: calc({api_data['pdi_s'][2]['b']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][2]['b_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-4bp {{
      position: relative;
      width: calc({api_data['pdi_s'][1]['b']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][1]['b_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-3mp {{
      position: relative;
      width: calc({api_data['pdi_s'][1]['gps']}*1%);
      height: 22px;
      border-radius: 5px 0px 0px 5px;
      background-color: {api_data['pdi_s'][1]['gp_c']};
    }}
    
    
    
    .final-done .rectangle-3mp2 {{
      position: relative;
      width: calc({api_data['pdi_s'][2]['gps']}*1%);
      height: 22px;
      border-radius: 5px 0px 0px 5px;
      background-color: {api_data['pdi_s'][2]['gp_c']};
    }}
    ...
    .final-done .rectangle-3t9mp {{
      position: relative;
      width: calc({api_data['pdi_s'][9]['gps']}*1%);
      height: 22px;
      border-radius: 5px 0px 0px 5px;
      background-color: {api_data['pdi_s'][9]['gp_c']};
    }}
    
    
    .final-done .rectangle-3t7mp {{
      position: relative;
      width: calc({api_data['pdi_s'][7]['gps']}*1%);
      height: 22px;
      border-radius: 5px 0px 0px 5px;
      background-color: {api_data['pdi_s'][7]['gp_c']};
    }}
    
    
    
    .final-done .rectangle-3t6mp {{
      position: relative;
      width: 58px;
      height: 22px;
      border-radius: 5px 0px 0px 5px;
      background-color: {api_data['pdi_s'][6]['gp_c']};
    }}
    
    
    .final-done .rectangle-3t8mp {{
      position: relative;
      width: calc({api_data['pdi_s'][8]['gps']}*1%);
      height: 22px;
      border-radius: 5px 0px 0px 5px;
      background-color: {api_data['pdi_s'][8]['gp_c']};
    }}
    
    
    
    .final-done .rectangle-3t5mp {{
      position: relative;
      width: calc({api_data['pdi_s'][5]['gps']}*1%);
      height: 22px;
      border-radius: 5px 0px 0px 5px;
      background-color: {api_data['pdi_s'][5]['gp_c']};
    }}
    
    
    .final-done .rectangle-3t4mp {{
      position: relative;
      width: calc({api_data['pdi_s'][4]['gps']}*1%);
      height: 22px;
      border-radius: 5px 0px 0px 5px;
      background-color: {api_data['pdi_s'][4]['gp_c']};
    }}
    
    
    .final-done .rectangle-3t3mp {{
      position: relative;
      width: calc({api_data['pdi_s'][3]['gps']}*1%);
      height: 22px;
      border-radius: 5px 0px 0px 5px;
      background-color: {api_data['pdi_s'][3]['gp_c']};
    }}
    ...
    .final-done .rectangle-4t9b {{
      position: relative;
      width: calc({api_data['pdi_s'][9]['b']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][9]['b_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-4t8b {{
      position: relative;
      width: calc({api_data['pdi_s'][8]['b']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][8]['b_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    
    .final-done .rectangle-4t7b {{
      position: relative;
      width: calc({api_data['pdi_s'][7]['b']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][7]['b_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    
    .final-done .rectangle-4t5b {{
      position: relative;
      width: calc({api_data['pdi_s'][5]['b']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][5]['b_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    
    .final-done .rectangle-4t3b {{
      position: relative;
      width: calc({api_data['pdi_s'][3]['b']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][3]['b_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-4t4b {{
      position: relative;
      width: calc({api_data['pdi_s'][4]['b']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][4]['b_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    ...
    .final-done .rectangle-5t9d {{
      position: relative;
      width: calc({api_data['pdi_s'][9]['d']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][9]['d_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-5t6d {{
      position: relative;
      width: calc({api_data['pdi_s'][6]['d']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][6]['d_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-5t7d {{
      position: relative;
      width: calc({api_data['pdi_s'][7]['d']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][7]['d_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-5t8d {{
      position: relative;
      width: calc({api_data['pdi_s'][8]['d']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][8]['d_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-5t5d {{
      position: relative;
      width: calc({api_data['pdi_s'][5]['d']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][5]['d_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-5t4d {{
      position: relative;
      width: calc({api_data['pdi_s'][4]['d']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][4]['d_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-5t3d {{
      position: relative;
      width: calc({api_data['pdi_s'][3]['d']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][3]['d_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-5t2d {{
      position: relative;
      width: calc({api_data['pdi_s'][2]['d']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][2]['d_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-5dp {{
      position: relative;
      width: calc({api_data['pdi_s'][1]['d']}*1%);
      height: 22px;
      color:#000000;
      border-radius: 5px 0px 0px 5px;
      background-color: {api_data['pdi_s'][1]['d_c']};
      
    }}
    
    
    .final-done .rectangle-6t8s {{
      position: relative;
      width: calc({api_data['pdi_s'][8]['s']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][8]['s_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    
    .final-done .rectangle-6t6s {{
      position: relative;
      width: calc({api_data['pdi_s'][6]['s']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][6]['s_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-6t7s {{
      position: relative;
      width: calc({api_data['pdi_s'][7]['s']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][7]['s_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    
    .final-done .rectangle-6t9s {{
      position: relative;
      width: calc({api_data['pdi_s'][9]['s']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][9]['s_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-6t5s {{
      position: relative;
      width: calc({api_data['pdi_s'][5]['s']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][5]['s_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-6t4s {{
      position: relative;
      width: calc({api_data['pdi_s'][4]['s']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][4]['s_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-6t3s {{
      position: relative;
      width: calc({api_data['pdi_s'][3]['s']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][3]['s_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-6t2s {{
      position: relative;
      width: calc({api_data['pdi_s'][2]['s']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][2]['s_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-6s {{
      position: relative;
      width: calc({api_data['pdi_s'][1]['s']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][1]['s_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-12s1 {{
      position: absolute;
      width: calc({api_data['pdi_s'][1]['gps']}*1%);
      height: 14px;
      top: 0;
    ...
    .final-done .rectangle-12s6 {{
      position: absolute;
      width: calc({api_data['pdi_s'][6]['gps']}*1%);
      height: 14px;
      top: 0;
      left: 0;
      background-color: #23b67a;
    ...
    .final-done .rectangle-scmp2 {{
      position: relative;
      width: calc({api_data['pdi_s'][0]['bgp']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][0]['bgp_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    
    .final-done .rectangle-scmp3 {{
      position: relative;
      width: calc({api_data['pdi_s'][0]['b']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][0]['b_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    .final-done .rectangle-scmp4 {{
      position: relative;
      width: calc({api_data['pdi_s'][0]['d']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][0]['d_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    
    
    
    .final-done .rectangle-scmp5 {{
      position: relative;
      width: calc({api_data['pdi_s'][0]['s']}*1%);
      height: 22px;
      background-color: {api_data['pdi_s'][0]['s_c']};
      border-radius: 5px 0px 0px 5px;
    }}
    ...
    .text-wrapper-101 {{
        ...
        <body>
            <div class="final-done">
              ...
              border-radius: 5px 5px 0px 0px;">
                ...
                font-size: 11.5px;
                letter-spacing: 0;
                line-height: normal;">Theme 1 - Poverty Free</p>
                                 
                                   <div style="
                                   
                                   margin-left:120px;"><svg style="position: relative;
                width: 28.64px;
                height: 28.64px;
              ...
              border-radius: 5px;">
                ...
                font-size: 12px;
                letter-spacing: 0;
                line-height: normal;">&nbsp; &nbsp;&nbsp; {api_data['pdi_s'][1]['bgp_g'][0:1]} &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; {api_data['pdi_s'][1]['bgp']}</div>
                                    </div>
                                    <p style="width: 143px;
              margin-top: -1px;
              margin-right: -147px;
              ...
              line-height: normal;">
                                      ...
                                      <span style="font-weight: 700;">{api_data['pdi_s'][1]['bgpn']}</span>
                                    </p>
                                  </div>
                                  <div style="display: flex;
      align-items: center;
      ...
      font-size: 12px;
      letter-spacing: 0;
      line-height: normal;">&nbsp; &nbsp;&nbsp;{api_data['pdi_s'][1]['gp_g'][:2]} &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; {api_data['pdi_s'][1]['gps']}</div>
                                    </div>
      ...
      font-size: 12px;
      letter-spacing: 0;
      line-height: normal;">&nbsp; &nbsp;&nbsp;{api_data['pdi_s'][1]['b_g'][:2]}&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;{api_data['pdi_s'][1]['b']}</div>
                                    </div>
                                    <div style="position: relative;
      width: fit-content;
      font-family: 'Noto Sans', Helvetica;
      ...
      font-size: 12px;
      letter-spacing: 0;
      line-height: normal;">&nbsp; &nbsp;&nbsp;{api_data['pdi_s'][1]['d_g'][:2]} &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; {api_data['pdi_s'][1]['d']}</div>
                                    </div>
                                    <div style="position: relative;
      width: fit-content;
      font-family: 'Noto Sans', Helvetica;
      ...
      font-size: 12px;
      letter-spacing: 0;
      line-height: normal;">&nbsp; &nbsp;&nbsp;{api_data['pdi_s'][1]['s_g'][:2]}   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  {api_data['pdi_s'][1]['s']}</div>
                                    </div>
                                    <div style="position: relative;
      width: fit-content;
      font-family: 'Noto Sans', Helvetica;
      ...
      line-height: normal;">State</div>
              ...
              border-radius: 5px 5px 0px 0px;">
                ...
                font-size: 11.5px;
                letter-spacing: 0;
                line-height: normal;">Theme 2 - Healthy</p>
              ...
              border-radius: 5px;">
                ...
                font-size: 12px;
                letter-spacing: 0;
                line-height: normal;">&nbsp; &nbsp;&nbsp; {api_data['pdi_s'][2]['bgp_g'][:2]} &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; {api_data['pdi_s'][2]['bgp']}</div>
                                    </div>
                                    <p style="width: 143px;
              margin-top: -1px;
              margin-right: -147px;
              ...
              line-height: normal;">
                                      <span style="font-weight: 500;">Best Panchayat </span>
                                      <span style="font-weight: 700;">{api_data['pdi_s'][2]['bgpn']}</span>
                                    </p>
                                  </div>
                                  <div style="display: flex;
      align-items: center;
      ...
      font-size: 12px;
      letter-spacing: 0;
      line-height: normal;">&nbsp; &nbsp;&nbsp;{api_data['pdi_s'][2]['gp_g'][:2]} &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; {api_data['pdi_s'][2]['gps']}</div>
                                    </div>
                                    <div style="position: relative;
      width: fit-content;
      font-family: 'Noto Sans', Helvetica;
      ...
      font-size: 12px;
      letter-spacing: 0;
      line-height: normal;">&nbsp; &nbsp;&nbsp;{api_data['pdi_s'][2]['b_g'][:2]}&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;{api_data['pdi_s'][2]['b']}</div>
                                    </div>
                                    <div style="position: relative;
      width: fit-content;
      font-family: 'Noto Sans', Helvetica;
      ...
      font-size: 12px;
      letter-spacing: 0;
      line-height: normal;">&nbsp; &nbsp;&nbsp;{api_data['pdi_s'][2]['d_g'][:2]} &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; {api_data['pdi_s'][2]['d']}</div>
                                    </div>
                                    <div style="position: relative;
      width: fit-content;
      font-family: 'Noto Sans', Helvetica;
      ...
      font-size: 12px;
      letter-spacing: 0;
      line-height: normal;">&nbsp; &nbsp;&nbsp;{api_data['pdi_s'][2]['s_g'][:2]}   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  {api_data['pdi_s'][2]['s']}</div>
                                    </div>
                                    <div style="position: relative;
      width: fit-content;
      font-family: 'Noto Sans', Helvetica;
      ...
      line-height: normal;">State</div>
              ...
              border-radius: 5px 5px 0px 0px;">
                ...
                font-size: 11.5px;
                letter-spacing: 0;
                line-height: normal;">Theme 3 - Child Friendly</p>
              ...
              border-radius: 5px;">
                ...
                font-size: 12px;
                letter-spacing: 0;
                line-height: normal;">&nbsp; &nbsp;&nbsp; {api_data['pdi_s'][3]['bgp_g'][0:1]} &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; {api_data['pdi_s'][3]['bgp']}</div>
                                    </div>
                                    <p style="width: 143px;
              margin-top: -1px;
              margin-right: -147px;
              ...
              line-height: normal;">
                                      <span style="font-weight: 500;">Best Panchayat </span>
                                      <span style="font-weight: 700;">{api_data['pdi_s'][3]['bgpn']}</span>
                                    </p>
                                  </div>
                                  <div style="display: flex;
      align-items: center;
      ...
      font-size: 12px;
      letter-spacing: 0;
      line-height: normal;">&nbsp; &nbsp;&nbsp;{api_data['pdi_s'][3]['gp_g'][:2]} &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; {api_data['pdi_s'][3]['gps']}</div>
                                    </div>
                                    <div style="position: relative;
      width: fit-content;
      font-family: 'Noto Sans', Helvetica;
      ...
      font-size: 12px;
      letter-spacing: 0;
      line-height: normal;">&nbsp; &nbsp;&nbsp;{api_data['pdi_s'][3]['b_g'][:2]}&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp;{api_data['pdi_s'][3]['b']}</div>
                                    </div>
                                    <div style="position: relative;
      width: fit-content;
      font-family: 'Noto Sans', Helvetica;
      ...
      font-size: 12px;
      letter-spacing: 0;
      line-height: normal;">&nbsp; &nbsp;&nbsp;{api_data['pdi_s'][3]['d_g'][:2]} &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp; &nbsp;  &nbsp; &nbsp; &nbsp; &nbsp; {api_data['pdi_s'][3]['d']}</div>
                                    </div>
                                    <div style="position: relative;
      width: fit-content;
      font-family: 'Noto Sans', Helvetica;
      ...
      font-size: 12px;
      letter-spacing: 0;
      line-height: normal;">&nbsp; &nbsp;&nbsp;{api_data['pdi_s'][3]['s_g'][:2]}   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;  {api_data['pdi_s'][3]['s']}</div>
                                    </div>
                                    <div style="position: relative;
      width: fit-content;
      font-family: 'Noto Sans', Helvetica;
      ...
      line-height: normal;">State</div>
                ...
                width: 100%;
                background-color: #696969;
                border-radius: 5px 5px 0px 0px;"><div style="position: relative;
                width: fit-content;
                font-family: 'Inter', Helvetica;
                font-weight: 500;
                color: #ffffff;
                ...
                letter-spacing: 0;
                line-height: normal;
                white-space: nowrap;">Grade Guidance</div></div>
                            <div style="display: flex;
                flex-direction: column;
                align-items: flex-start;
                gap: 35px;
                ...
                background-color: #5a9bd5;
                border-radius: 4px;
                box-shadow: 0px 4px 4px #00000040;"></div>
                                  <div style="display: flex;
                flex-direction: column;
                width: 213px;
                align-items: flex-start;
                ...
                font-size: 14px;
                letter-spacing: 0;
                line-height: normal;">A+&nbsp;&nbsp;- Achiever</div>
                                    <p style="position: relative;
                align-self: stretch;
                font-family: 'Noto Sans', Helvetica;
                font-weight: 500;
                ...
                font-size: 14px;
                letter-spacing: 0;
                line-height: normal;">PDI Score between 90 and 100</p>
                                  </div>
                                </div>
                              </div>
                              <div style="display: flex;
                ...
                width: 100%;
                flex: 0 0 auto;">
                                  <div style="background-color: #90cf8e;
                position: relative;
                width: 37px;
                height: 37px;
                border-radius: 4px;
                ...
                font-size: 14px;
                letter-spacing: 0;
                line-height: normal;">A&nbsp;&nbsp;- Front Runner</div>
                                    <p style="position: relative;
                align-self: stretch;
                font-family: 'Noto Sans', Helvetica;
                font-weight: 500;
                ...
                font-size: 14px;
                letter-spacing: 0;
                line-height: normal;">PDI Score between 75 and 89</p>
                                  </div>
                                </div>
                              </div>
                              <div style="display: flex;
                ...
                width: 100%;
                flex: 0 0 auto;">
                                  <div style=" background-color: #ffdc5e;
                position: relative;
                width: 37px;
                height: 37px;
                border-radius: 4px;
                ...
                font-size: 14px;
                letter-spacing: 0;
                line-height: normal;">B&nbsp;&nbsp;-&nbsp;&nbsp;Performer</div>
                                    <p style="position: relative;
                align-self: stretch;
                font-family: 'Noto Sans', Helvetica;
                font-weight: 500;
                ...
                font-size: 14px;
                letter-spacing: 0;
                line-height: normal;">PDI Score between 60 and 74</p>
                                  </div>
                                </div>
                              </div>
                              <div style="display: flex;
                ...
                width: 100%;
                flex: 0 0 auto;">
                                  <div style="background-color: #fc852d;
                position: relative;
                width: 37px;
                height: 37px;
                border-radius: 4px;
                ...
                font-size: 14px;
                letter-spacing: 0;
                line-height: normal;">C&nbsp;&nbsp;- Aspirant</div>
                                    <p style="position: relative;
                align-self: stretch;
                font-family: 'Noto Sans', Helvetica;
                font-weight: 500;
                ...
                font-size: 14px;
                letter-spacing: 0;
                line-height: normal;">PDI Score between 40 and 59</p>
                                  </div>
                                </div>
                              </div>
                              <div style="display: flex;
                ...
                width: 100%;
                flex: 0 0 auto;">
                                  <div style=" background-color: #95192f;
                position: relative;
                width: 37px;
                height: 37px;
                border-radius: 4px;
                ...
                font-size: 14px;
                letter-spacing: 0;
                line-height: normal;">D&nbsp;&nbsp;- Beginner</div>
                                    <p style="position: relative;
                align-self: stretch;
                font-family: 'Noto Sans', Helvetica;
                font-weight: 500;
                ...
                font-size: 14px;
                letter-spacing: 0;
                line-height: normal;">PDI Score between 0 and 39</p>
                                  </div>
                                </div>
                              </div>
                            </div>
                          ...
                          <div class="frame-39">
                            <div class="frame-34"><p style="position: relative;
                width: fit-content;
                font-family: 'Inter', Helvetica;
                font-weight: 500;
                color: #ffffff;
                ...
                letter-spacing: 0;
                line-height: normal;
                white-space: nowrap;">PDI Score of Your Gram Panchayat</p></div>
                            <div class="frame-40">
                              <div class="group-8">
                                <div class="overlap-2">
                                  <div class="t">
                        ...
                        <div class="text-wrapper-23">{t1}</div>
                        </div>
                        </div>
                        </div>
                        </div>
                        ...
                        <div class="text-wrapper-23">{t2}</div>
                        </div>
                        </div>
                        ...
                        <div class="text-wrapper-23">{t3}</div>
                        </div>
                        </div>
                        <div class="overlap-7">
                        ...
                        <div class="text-wrapper-23">{t4}</div>
                        </div>
                        </div>
                        ...
                        <div class="text-wrapper-23">{t5}</div>
                        </div>
                        </div>
                        ...
                        <div class="text-wrapper-23">{t6}</div>
                        </div>
                        </div>
                        ...
                        <div class="text-wrapper-23">{t7}</div>
                        </div>
                        </div>
                        ...
                        <div class="text-wrapper-23">{t8}</div>
                        </div>
                        </div>
                        ...
                        <div class="text-wrapper-23">{t9}</div>
                        </div>
                        </div>
      ...
      font-size: 14px;
      letter-spacing: 0;
      line-height: normal;">{api_data['pdi_s'][0]['gp_g']}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{api_data['pdi_s'][0]['gps']}</div>
            ...
            <div style="position: relative;
                ...
                text-align: center;
                letter-spacing: 0;
                line-height: 16px;">My Panchayat PDI Score</div>
            </div>
            <div style="display: inline-flex;
            align-items: center;
            gap: 11px;
      ...
      font-size: 14px;
      letter-spacing: 0;
      line-height: normal;">{api_data['pdi_s'][0]['bgp_g']}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{api_data['pdi_s'][0]['bgp']}</div>
      ...
      line-height: 8px;
      padding-bottom: 5px;">
              <span style="font-weight: 500; ">BP&nbsp;&nbsp;Score </span>
            </p>
            <p style="width: 110px; 
    font-family: 'Noto Sans', Helvetica;
    font-weight: 400;
    ...
    white-space: nowrap;
    overflow: hidden;
    text-overflow: ellipsis;"><span style="font-weight: 700;">{api_data['pdi_s'][0]['bgpn'] }  </span></p>
            </div>
            </div>
            <div style="display: inline-flex;
      align-items: center;
      ...
      font-size: 14px;
      letter-spacing: 0;
      line-height: normal;">{api_data['pdi_s'][0]['b_g']}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{api_data['pdi_s'][0]['b']}</div>
            ...
            <div style="position: relative;
                ...
                text-align: center;
                letter-spacing: 0;
                line-height: 16px;">Block&nbsp;&nbsp;PDI Score</div>
            </div>
            <div style="display: inline-flex;
                align-items: center; 
                gap: 8px;
      ...
      font-size: 14px;
      letter-spacing: 0;
      line-height: normal;">{api_data['pdi_s'][0]['d_g']}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{api_data['pdi_s'][0]['d']}</div>
