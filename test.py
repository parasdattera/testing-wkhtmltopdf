...
html_content = f"""
    ...
    .final-done .rectangle-2t2bp {{
      position: relative;
      width: calc({{api_data['pdi_s'][2]['bgp']}}*1%);
      height: 22px;
      border-radius: 5px 0px 0px 5px;
    ...
    .final-done .text-wrapper-50 {{
      ...
      @font-face {{
        font-family: 'Kadwa';
        src: url('./Kadwa/Kadwa-Bold.woff2') format('woff2'),
             url('./Kadwa/Kadwa-Bold.woff') format('woff'),
             url('./Kadwa/Kadwa-Bold.ttf') format('truetype');
        font-weight: 700;
        font-style: normal; 
      }}
    ...
    * {{
        ...
        <div class="final-done">
          <div class="overlap-wrapper">
            <div class="overlap">
                ...
                <div class="text-wrapper-23">{api_data['matrix'][0]['t1'].replace('\\nB', '')}</div>
                </div>
                </div>
                </div>
                </div>
                ...
                <div class="text-wrapper-23">{api_data['matrix'][0]['t2'].replace('\\nA', '')}</div>
                </div>
                </div>
                ...
                <div class="text-wrapper-23">{api_data['matrix'][0]['t3'].replace('\\nB', '')}</div>
                </div>
                </div>
                <div class="overlap-7">
                ...
                <div class="text-wrapper-23">{api_data['matrix'][0]['t4'].replace('\\nB', '')}</div>
                </div>
                </div>
                ...
                <div class="text-wrapper-23">{api_data['matrix'][0]['t5'].replace('\\nC', '')}</div>
                </div>
                </div>
                ...
                <div class="text-wrapper-23">{api_data['matrix'][0]['t6'].replace('\\nC', '')}</div>
                </div>
                </div>
                ...
                <div class="text-wrapper-23">{api_data['matrix'][0]['t7'].replace('\\nB', '')}</div>
                </div>
                </div>
                ...
                <div class="text-wrapper-23">{api_data['matrix'][0]['t8'].replace('\\nC', '')}</div>
                </div>
                </div>
                ...
                <div class="text-wrapper-23">{api_data['matrix'][0]['t9'].replace('\\nB', '')}</div>
                </div>
                </div>
    ...
    <div class="text-wrapper-33">{ api_data['matrix'][0]['pdi_score'].replace('\\nC', '') }</div> -->
    <!-- <p class="c-aspirant">
    ...
    <div class="text-wrapper-42">{api_data['matrix'][0]['pdi_score'].replace("\\nC","")}</div>
    <div class="text-wrapper-42">{api_data['pdi_s'][0]['gp_g'][:2]}</div>
    </div>
    <div class="frame-64">
    <div class="text-wrapper-43">{api_data['matrix'][0]['t1'].replace("\\nB","")}</div>
    <div class="text-wrapper-43">{api_data['pdi_s'][1]['gp_g'][:2]}</div>
    </div>
    <div class="frame-65">
    <div class="text-wrapper-42">{api_data['matrix'][0]['t2'].replace("\\nA","")}</div>
    <div class="text-wrapper-42">{api_data['pdi_s'][2]['gp_g'][:2]}</div>
    </div>
    <div class="frame-66">
    <div class="text-wrapper-42">{api_data['matrix'][0]['t3'].replace("\\nB","")}</div>
    <div class="text-wrapper-42">{api_data['pdi_s'][3]['gp_g'][:2]}</div>
    </div>
    <div class="frame-67">
    <div class="text-wrapper-42">{api_data['matrix'][0]['t4'].replace("\\nB","")}</div>
    <div class="text-wrapper-42">{api_data['pdi_s'][4]['gp_g'][:2]}</div>
    </div>
    <div class="frame-68">
    <div class="text-wrapper-42">{api_data['matrix'][0]['t5'].replace("\\nC","")}</div>
    <div class="text-wrapper-42">{api_data['pdi_s'][5]['gp_g'][:2]}</div>
    </div>
    <div class="frame-69">
    <div class="text-wrapper-42">{api_data['matrix'][0]['t6'].replace("\\nC","")}</div>
    <div class="text-wrapper-42">{api_data['pdi_s'][6]['gp_g'][:2]}</div>
    </div>
    <div class="frame-68">
    <div class="text-wrapper-42">{api_data['matrix'][0]['t7'].replace("\\nB","")}</div>
    <div class="text-wrapper-42">{api_data['pdi_s'][7]['gp_g'][:2]}</div>
    </div>
    <div class="frame-69">
    <div class="text-wrapper-42">{api_data['matrix'][0]['t8'].replace("\\nC","")}</div>
    <div class="text-wrapper-42">{api_data['pdi_s'][8]['gp_g'][:2]}</div>
    </div>
    <div class="frame-70">
    <div class="text-wrapper-43">{api_data['matrix'][0]['t9'].replace("\\nB","")}</div>
